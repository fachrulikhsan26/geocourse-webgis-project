...
DATABASES = {
    'default': {
        #'ENGINE': 'django.db.backends.postgresql', #Engine databes posstgres non spasial
        'ENGINE': 'django.contrib.gis.db.backends.postgis', #Engins database postgres spasial
        'HOST': env('DB_HOST'),
        'NAME': env('DB_NAME'),
        'USER': env('DB_USER'),
